/**
 * Contrat d'API partagé avec le backend Overtify.
 *
 * Copie conforme de backend/src/types/dto.ts. La duplication est assumée pour
 * garder deux projets npm indépendants (deux Dockerfiles, deux installs) ;
 * en contrepartie, toute modification doit être reportée des deux côtés.
 * Voir docs/ARCHITECTURE.md, section « Contrat d'API ».
 */
...
/** `position` est l'index 0-based dans la playlist : la clé de suppression. */
